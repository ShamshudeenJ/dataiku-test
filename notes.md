...
## Scenarios
* Step based (Visual) vs Code based (Python)
* Step based scenario Components
  - Sequence of steps
  - Triggers
  - Reporters (optional)
* Types of triggers
  - Time based
  - Dataset change
  - SQL query (result is diff)
  - Custom python trigger
* Reporters: Teams, email
* Managed datasets are dataset generated by Dataiku. like scenarios (last few runs) result

## Dataiku API
* Let you interact programmatically with Dataiku objects and the platform itself
* Category
  - Instance and project operations
  - Object level operations
* Public REST api: https://doc.dataiku.com/dss/latest/publicapi/index.html
* Python API: https://developer.dataiku.com/latest/api-reference/python/index.html#gsc.tab=0

## Code notebooks 
* SQL : Hive, Imapala, Spark SQL
